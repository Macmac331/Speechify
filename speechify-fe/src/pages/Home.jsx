...
const Home = () => {
    ...
    <div className='h-[88vh] w-full md:w-[70vw] mx-auto flex items-center'>
        <div className='p-6 ml-4 md:p-0 md:ml-0'>
            <h1 className='text-4xl md:text-5xl font-Poppins font-semibold mb-5'>Welcome to Speechilyze!</h1>
            <p className='text-xl max-w-[550px] mb-5 font-Poppins'>Speechilyze is your trusted ally on the journey to confident communication. Whether preparing for impromptu speeches, refining presentations, or honing speaking skills, Speechilyze is the place to be.</p>
